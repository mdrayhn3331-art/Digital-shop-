...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Digital Shop — Gadgets, Audio & Accessories" },
      {
        name: "description",
        content:
          "Digital Shop is an online gadget store with fast delivery across Bangladesh. Pay with bKash, Nagad or cash on delivery.",
      },
